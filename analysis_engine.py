...
3. HISTORY:
   a) What TYPE of card wins with this MF historically? What trait hierarchy does this reveal?
   b) Has Home or Away appeared with this MF before?
   c) Have Home and Away appeared together before? If they drew, what MF was it under? A draw under a different MF means they were equal on THAT MF's traits, not necessarily these.
   d) Use history to confirm, challenge, or break ties in meaning analysis.

4. CALL: OPP beats SIM. Both same type: specificity wins. History breaks genuine ties. Draw only if truly indistinguishable.
